...
- [x] Dynamically assign and listen to ports defined in the YAML.
- [x] Conditional outputs based on variables/state.
- [x] Conditional operations based on variables/state.
